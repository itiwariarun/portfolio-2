...
import developerLight from "../../img/developer.svg";
import developerDark from "../../img/developer-dark.svg";
    ...
    >
      ...
      <div className="w-full md:w-1/3 text-right">
        <motion.h1
          ...
          className="font-general-semibold text-2xl lg:text-3xl xl:text-4xl text-center sm:text-right text-ternary-dark dark:text-primary-light uppercase"
        >
          Hi, I am Arun
        </motion.h1>
        <motion.p
          ...
          className="font-general-medium mt-4 text-lg md:text-xl lg:text-2xl xl:text-3xl text-center sm:text-right leading-normal text-gray-500 dark:text-gray-200"
        >
