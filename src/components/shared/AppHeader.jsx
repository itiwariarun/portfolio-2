  ...
  return (
    ...
    >
      <div className="z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center py-6">
        ...
        {showMenu && (
          <div className="block sm:hidden m-0 sm:ml-4 mt-5 sm:mt-3  p-5 sm:p-0 justify-center items-center shadow-lg sm:shadow-none">
            ...
            <div className="border-t-2 pt-3 sm:pt-0 sm:border-t-0 border-primary-light dark:border-secondary-dark">
              <span
                ...
                className="font-general-medium sm:hidden block rounded-md text-left text-md bg-cyan-700 hover:bg-cyan-900 text-white shadow-sm  px-4 py-2 mt-2 duration-300 w-24"
